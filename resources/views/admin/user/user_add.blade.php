					...
					<li class="nav-item">
						...
						<div class="container-fluid">
							<div class="body-main">
								...
								<form action="{{route('user.ins')}}" method="post" id="frm">
									@csrf
									<div class="top-row faq-sec">
										<div class="form-group my-3">
											<label class="form-label">User name:</label>
											<input class="form-control" placeholder="Enter name" type="text" name="name" style="width: 30%">
										...
										<div class="form-group my-3">
											...
											<input class="form-control" placeholder="Enter email" type="email" name="email" style="width: 30%">
										...
										<div class="form-group my-3">
											...
											<input class="form-control" placeholder="Enter password" type="text" name="password" style="width: 30%">
										...
										<div class="form-group my-3">
											...
											<select class="form-control rm06" name="role"  style="width: 30%" >
												...
												<option {{-- selected --}} value="{{$val->id}}" >{{$val->role_name}} ({{$val->perName->name}})</option>
