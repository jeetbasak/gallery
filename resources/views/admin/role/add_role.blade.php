					...
					<li class="nav-item">
						...
						<div class="container-fluid">
							<div class="body-main">
								...
								<form action="{{route('role.ins')}}" method="post" id="frm">
									@csrf
									<div class="top-row faq-sec">
										<div class="form-group my-3">
											<label class="form-label">Role name:</label>
											<input class="form-control" placeholder="Enter Role" type="text" name="role" style="width: 30%">
										...
										<div class="form-group my-3">
											...
											<br>
											<select class="form-control rm06" name="per_id[]" multiple id="slct1" style="width: 30%" >
												{{--  --}}
